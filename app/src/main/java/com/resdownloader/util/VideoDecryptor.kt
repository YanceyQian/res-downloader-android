...
object VideoDecryptor {
    ...
    private fun decryptWechatVideo(sourceFile: File, destFile: File, decodeKey: String): DecryptResult {
        Log.d(TAG, "Decrypting file with key")
        ...
        return try {
            ...
            Log.d(TAG, "File decrypted successfully: $originalSize -> $decryptedSize bytes")
            ...
            Log.e(TAG, "Decryption failed, trying alternative method", e)
